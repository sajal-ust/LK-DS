...
#     train_df, test_df = train_df, test_df = train_test_split(df, test_size=0.2, random_state=42)
...
#     }
#     try:
#         df = load_file_from_s3(bucket_name, input_key) if is_lambda else load_file_locally("Augmented_Stockist_data.csv")
