...
def save_results_to_csv_wrapper(merged_df, output_s3_key, is_lambda, bucket_name=None):
    ...
    try:
        if is_lambda:
            ...
            metrics_filename = f"RoBERTa_Sentiment_Predictions.csv"
...
def save_outputs(df, classification_report_text, output_dir=r'C:\Users\291688\LKEA-Project\LK-DS\LKEA-AI-Project\Sentiment_Analysis_NLP_Model\RoBERTa_Model\output_folder'):
    import os
    os.makedirs(output_dir, exist_ok=True)
...
def lambda_handler(event, context):
    ...
    try:
        ...
        save_outputs(merged_df, report_df, output_dir=r"C:\Users\291688\LKEA-Project\LK-DS\LKEA-AI-Project\Sentiment_Analysis_NLP_Model\RoBERTa_Model\output_folder")
